...
const ServiceAreaPage = () => {
  const cities = [
    ...
    { name: 'Belvedere Park', link: '/belvedere-park' },
    { name: 'Decatur', link: '/decatur' },
    { name: 'Buckhead', link: '/buckhead' },
    { name: 'Milton', link: '/milton' },
    { name: 'Suwanee', link: '/suwanee' },
    { name: 'Johns Creek', link: '/johns-creek' },
    { name: 'Duluth', link: '/duluth' },
    { name: 'Cumming', link: '/cumming' },
    { name: 'Brookhaven', link: '/brookhaven' },
    { name: 'Kennesaw', link: '/kennesaw' },
    { name: 'Marietta', link: '/marietta' },
    { name: 'Smyrna', link: '/smyrna' },
    { name: 'Vinings', link: '/vinings' },
    { name: 'Sugar Hill', link: '/sugar-hill' },
    { name: 'Canton', link: '/canton' },
    { name: 'Woodstock', link: '/woodstock' },
    { name: 'Roswell', link: '/roswell' },
    { name: 'Buford', link: '/buford' },
    { name: 'Lawranceville', link: '/lawranceville' },
    { name: 'Sandy Springs', link: '/sandy-springs' },
    { name: 'Dunwoody', link: '/dunwoody' },
    { name: 'Chamblee', link: '/chamblee' },
    { name: 'Grayson', link: '/grayson' },
    { name: 'Lilburn', link: '/lilburn' },
    { name: 'Norcross', link: '/norcross' },
    { name: 'Peachtree Corners', link: '/peachtree-corners' },
    { name: 'Scottdale', link: '/scottdale' },
    { name: 'Stone Mountain', link: '/stone-mountain' },
    { name: 'Tucker', link: '/tucker' }
  ];
