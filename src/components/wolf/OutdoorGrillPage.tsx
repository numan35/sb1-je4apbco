...
const OutdoorGrillPage = () => {
  const features = [
    {
      ...
      description: "Expert repair of Wolf outdoor grill systems",
      items: [
    ...
    },
    {
      ...
      description: "Comprehensive repair for Wolf side burners",
      items: [
        "Burner maintenance",
    ...
    },
    {
      ...
      description: "Complete service for Wolf grill accessories",
      items: [
        "Smoker box repair",
  ...
  return (
    <>
      <Helmet>
        <title>Wolf Outdoor Grill Repair Atlanta | Expert Service</title>
        <meta name="description" content="Expert Wolf outdoor grill repair in Atlanta. Factory-certified service for gas grills, side burners & grill accessories. Same-day service available. Call (404) 200-7265" />
        <meta name="keywords" content="Wolf grill repair Atlanta, Wolf outdoor kitchen service, Wolf BBQ repair, Wolf side burner maintenance" />
        <link rel="canonical" href="https://premiumappliance.co/wolf/outdoor-grill" />
        <script type="application/ld+json">
          {`
            {
              "@context": "https://schema.org",
              "@type": "Service",
              "name": "Wolf Outdoor Grill Repair",
              "provider": {
                "@type": "LocalBusiness",
              ...
              "description": "Expert repair services for Wolf outdoor grills including gas grills, side burners, and accessories"
            }
          `}
        </script>
      </Helmet>
      ...
      <div className="pt-24 pb-16">
        <div className="relative h-[400px] mb-16">
          <div 
            ...
            style={{ 
              backgroundImage: 'url("/wolfGrill.jpg")',
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Wolf Outdoor Grill Repair Services
                </h1>
                <p className="text-xl text-gray-200">
                  Expert repair for all Wolf outdoor grill models by factory-certified technicians
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="mb-16">
              <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-3xl font-bold text-navy-900 mb-4">
                  Professional Wolf Outdoor Grill Services
                </h2>
                <p className="text-gray-600 text-lg">
                  Our factory-certified technicians specialize in all aspects of Wolf outdoor grill repair,
          ...
          <AnimatedSection delay={200}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-gold-500">
                ...
                <p className="text-gray-600">Our technicians are factory-trained for all Wolf outdoor products</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-gold-500">
          ...
          <AnimatedSection delay={300}>
            <div className="bg-navy-900 rounded-xl p-8 text-center">
              <h2 className="text-3xl font-bold text-white mb-4">Schedule Your Wolf Grill Repair</h2>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Our expert technicians are ready to help with any Wolf outdoor grill repair needs.
