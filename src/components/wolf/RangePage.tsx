...
const RangePage = () => {
  const features = [
    {
      ...
      description: "Expert repair of Wolf's professional gas range systems",
      items: [
        "Dual-stacked sealed burner repair",
    ...
    {
      title: "Dual Fuel Range Service",
      description: "Comprehensive repair for Wolf dual fuel ranges",
      items: [
        "Electric oven control repair",
    ...
    {
      title: "Range Hood Integration",
      description: "Complete service for integrated ventilation systems",
      items: [
  ...
  return (
    <>
      <Helmet>
        <title>Wolf Range Repair Atlanta | Expert Wolf Range Service</title>
        <meta name="description" content="Expert Wolf range repair in Atlanta. Factory-certified service for gas ranges, dual fuel ranges & professional ranges. Same-day service available. Call (404) 200-7265" />
        <meta name="keywords" content="Wolf range repair Atlanta, Wolf gas range service, Wolf dual fuel range repair, Wolf professional range maintenance" />
        <link rel="canonical" href="https://premiumappliance.co/wolf/range" />
          ...
          {`
            {
              ...
              "description": "Expert repair services for Wolf ranges including gas, dual fuel, and professional models"
            }
          `}
        </script>
      </Helmet>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                  Wolf Range Repair Services
                </h1>
                <p className="text-xl text-gray-200">
                  Expert repair for all Wolf range models by factory-certified technicians
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="mb-16">
              <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-3xl font-bold text-navy-900 mb-4">
                  Professional Wolf Range Services
                </h2>
                <p className="text-gray-600 text-lg">
                  Our factory-certified technicians specialize in all aspects of Wolf range repair,
                  from gas systems to electronic controls.
                </p>
              </div>
          ...
          <AnimatedSection delay={200}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-gold-500">
                ...
                <p className="text-gray-600">Our technicians are factory-trained for all Wolf range models</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-gold-500">
          ...
          <AnimatedSection delay={300}>
            <div className="bg-navy-900 rounded-xl p-8 text-center">
              <h2 className="text-3xl font-bold text-white mb-4">Schedule Your Wolf Range Repair</h2>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Our expert technicians are ready to help with any Wolf range repair needs.
